...
class ShorVideoTab(QWidget):
    """Tanıtım yazısı + video + metin düzeni."""
    ...
    def __init__(self, media: Optional[MediaPack] = None, parent=None):
        ...
        self.media = media or MediaPack(
            ...
            description="Bu bölümde videonun kısa tanıtımını, özelliklerini ve açıklama metnini gösterebilirsin.",
        )
    ...
    def _build_ui(self) -> None:
        ...
        # Ana içerik: solda video, sağda metin
        ...
        # Videonun içindeki küçük butonlar (sol üst)
        ...
        content_row.addWidget(self.video_card, stretch=2)
        ...
        content_row.addWidget(self.info_box, stretch=1)
